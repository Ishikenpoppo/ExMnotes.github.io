...
export function renderNoteCard(note, tagsMap = {}, opts = {}) {
  ...
  // PDF badge
  const pdfBadge = note.pdfData
    ? `<span class="pdf-badge" title="PDF allegato">
  ...
  el.innerHTML = `
    ...
    <div class="note-card-footer">
      ...
      <div style="display:flex;align-items:center;gap:var(--sp-2);">${linkBadge}${audioBadge}${pdfBadge}</div>
    </div>
